...
public class CuerdaResponseDtoTests
{
    ...
    public void Constructor_SetsProperties()
    {
        ...
        var dto = new CuerdaResponseDto(id, tournamentId, "Babolat", "Pure Drive", 10, 199.99, "16x19", "Polyester", 1.25, "test.jpg");
    ...
    {
        var tournamentId = Ulid.NewUlid();
        var dto1 = new CuerdaResponseDto(1, tournamentId, "Marca", "Modelo", 5, 99.99, "16x19", "Nylon", 1.25, "test.jpg");
        var dto2 = new CuerdaResponseDto(1, tournamentId, "Marca", "Modelo", 5, 99.99, "16x19", "Nylon", 1.25, "test.jpg");
    ...
    public void Equality_DifferentValues_AreNotEqual()
    {
        var tournamentId = Ulid.NewUlid();
        var dto1 = new CuerdaResponseDto(1, tournamentId, "Marca", "Modelo", 5, 99.99, "16x19", "Nylon", 1.25, "test.jpg");
        var dto2 = new CuerdaResponseDto(2, tournamentId, "Marca", "Modelo", 5, 99.99, "16x19", "Nylon", 1.25, "test.jpg");
    ...
    {
        var tournamentId = Ulid.NewUlid();
        var dto = new CuerdaResponseDto(42, tournamentId, "Wilson", "Blade", 3, 159.50, "18x20", "Multi", 1.25, "test.jpg");

        var (id, tid, marca, modelo, stock, precio, format, type, calibre, imageUrl) = dto;
