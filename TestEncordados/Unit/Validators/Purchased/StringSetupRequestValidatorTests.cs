...
public class StringSetupRequestValidatorTests
{
    private StringSetupRequestValidator CreateValidator() => new();
    ...
    [Test]
    public void Validate_VerticalOnlySetup_ReturnsNoErrors()
    {
        var validator = CreateValidator();
    ...
    [Test]
    public void Validate_FullCrossStringSetup_ReturnsNoErrors()
    {
        var validator = CreateValidator();
        var dto = new StringSetupDto
        {
