...
public interface ITournamentService
{
    ...
    Task<Result<TournamentResponseDetailsDto, TournamentsErrors>> UpdateTournament(long id, TournamentPatchDto request);
    ...
    Task<Result<TournamentResponseDetailsDto, TournamentsErrors>> UnassignWorkerMachine(long tournamentId, WorkerMachineAssignmentRequestDto request);
