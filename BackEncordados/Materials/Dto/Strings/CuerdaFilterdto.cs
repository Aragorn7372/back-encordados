...
/// <summary>
/// DTO de filtro para la búsqueda paginada de cuerdas.
/// </summary>
/// <remarks>
/// <para>Se utiliza en el endpoint GET del <c>CuerdasController</c>
/// para aplicar filtros, paginación y ordenamiento a la consulta de cuerdas.</para>
/// <para><b>Campos:</b></para>
/// <list type="bullet">
///   <item><description><c>TournamentId</c> — filtra por torneo específico (opcional).</description></item>
///   <item><description><c>Search</c> — término de búsqueda general (opcional).</description></item>
